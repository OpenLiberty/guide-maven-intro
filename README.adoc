...
:page-description: Learn how to build and test a simple web application using a Maven Project Object Model (POM) file and the Liberty Maven plug-in.
...
* **Build plug-ins** (`<build />`): Maven is modular and each of its capabilities is provided by a separate plug-in. This is where you specify which Maven plug-ins should be used to build this project and any configuration information needed by those plug-ins.
...
Configure the Maven plug-ins that build this project:
