...
[role="code_command hotspot=10-15", subs="quotes"]
----
...
[source, xml, linenums, role='code_column']
----
include::finish/pom.xml[tags=whole;coordinates;!*]
----
...
----
include::finish/src/test/java/io/openliberty/guides/hello/it/EndpointIT.java[tags=**]
----
