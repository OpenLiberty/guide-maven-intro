...
:page-seo-description: A getting started tutorial and an example on how to build and test a simple Java or Jakarta EE web application using a Maven Project Object Model (POM) file. 
