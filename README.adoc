...
In the [hotspot=liberty-maven-plugin file=0]`liberty-maven-plugin` plugin section, you can add the
`<stripVersion/>` field to remove the version number from the name of the application 
