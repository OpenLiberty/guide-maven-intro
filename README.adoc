...
Using a build tool like Maven is beneficial as you can define the details of the projects and its dependencies.
...
Choosing a build tool often comes down to personal preference, but Maven has some benefits.  
As a mature build tool, Maven has greater integrations with IDEs. 
