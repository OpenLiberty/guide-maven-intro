...
Starting with version **3.11.6**, the `liberty-maven-plugin` introduced support for **Maven Toolchains** to address these needs:
...
The `liberty-maven-plugin` supports Maven Toolchains starting from version **3.11.6**.
...
<plugin>
    ...
    <version>3.11.6</version> <configuration>
        <jdkToolchain>
            <version>17</version>
            <vendor>temurin</vendor>
        </jdkToolchain>
