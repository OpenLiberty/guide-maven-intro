...
:page-tags: ['Maven', 'web']
:page-permalink: /guides/building-web-application-maven
...
`src/test/java/io/openliberty/guides/hello/it/EndpointTest.java`:

[source,java]
----
include::finish/src/test/java/io/openliberty/guides/hello/it/EndpointTest.java[]
----
