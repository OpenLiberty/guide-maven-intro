...
One benefit of using build tools is that after you define the details of the project and any dependencies it has, the build tool automatically downloads and installs the dependencies. 
...
Maven's benefits are its greater integration with IDEs. 
Maven's plugin library also offers a great variety of ways to customize your projects.
The plugin library also helps to provide easier support for whatever customizations you're making to your project.
