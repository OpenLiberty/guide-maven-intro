...
* Tne `<finalName/>` element removes the version string from the output file names. This name is used as part of the URL to access the application. If you do not specify this value, Maven appends the project version to the file name.
...
The test code needs to know the location of the running application in order to make requests.
